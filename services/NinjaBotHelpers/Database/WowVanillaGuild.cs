...
/// <summary>
/// Discord server to WoW Vanilla/Classic Fresh guild association.
/// Shared table with NinjaBotCore.
/// </summary>
[Table("WowVanillaGuild")]
public class WowVanillaGuild
{
    [Key]
    ...
    /// <summary>
    /// WoW Vanilla guild name
    /// </summary>
    public string? WowGuild { get; set; }

    /// <summary>
    /// WoW Vanilla realm name
    /// </summary>
