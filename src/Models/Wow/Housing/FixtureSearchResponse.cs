...
namespace NinjaBotCore.Models.Wow.Housing
{
    ...
    public class FixtureSearchResponseResultsItemKey
    {
        [Newtonsoft.Json.JsonProperty("href")]
        public string Href { get; set; }
    }

    public class FixtureSearchResponseResultsItemDataName
    {
    ...
    public class FixtureSearchResponseResultsItemData
    {
        [Newtonsoft.Json.JsonProperty("name")]
        public FixtureSearchResponseResultsItemDataName Name { get; set; }

        [Newtonsoft.Json.JsonProperty("id")]
        public long Id { get; set; }
    }

    public class FixtureSearchResponseResultsItem
    {
        [Newtonsoft.Json.JsonProperty("key")]
        public FixtureSearchResponseResultsItemKey Key { get; set; }

        [Newtonsoft.Json.JsonProperty("data")]
        public FixtureSearchResponseResultsItemData Data { get; set; }
    }
    ...
    public class FixtureSearchResponse
    {
        ...
        public List<FixtureSearchResponseResultsItem> Results { get; set; }
    }
}
